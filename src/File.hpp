...
public:
  ...
  void write(std::string const &text, unsigned n = 1); //remplace le texte déjà existant à partir de la ligne n (n et tout ce qui suit sont remplacés)                                                       //n = 0 pour écrire sans rien remplacer à la fin du fichier
